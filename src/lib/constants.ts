import type { Interest, Horizon, LossTolerance, NewsFrequency, Volatility, WatchTag } from "@/types";
...
export const termDescriptions: Record<string, string> = {
  ...
  PBR: "주가가 회사 순자산 대비 몇 배인지 보는 지표예요. 자산 많은 기업을 볼 때 참고하기 좋아요.",
  EPS: "주식 1주당 벌어들인 이익입니다. 꾸준히 늘면 회사의 이익 체력이 좋아진다고 볼 수 있어요.",
