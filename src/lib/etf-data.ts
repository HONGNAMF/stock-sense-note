...
function makeEtf(symbol: string, name: string, market: "KR" | "US", issuer: string, character: Etf["character"], risk: Etf["risk"], oneLine: string): Etf {
  ...
  return {
    ...
    risk,
    oneLine,
    easyExplanation: "ETF는 여러 종목을 한 바구니에 담아 한 번에 분산해서 보는 상품입니다. 개별주보다 덜 흔들릴 수 있지만, 담긴 산업이 흔들리면 ETF도 하락할 수 있습니다.",
    ...
    comparison: "ETF는 개별주보다 한 회사 리스크는 낮지만, 특정 종목 급등만큼 수익률이 크지 않을 수 있습니다.",
