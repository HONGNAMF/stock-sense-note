...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    caution: "플랫폼이나 바이오처럼 미래 기대가 큰 회사에는 덜 맞을 수 있어요.",
    related: ["PER", "ROE", "시가총액"]
  },
  {
    term: "EPS",
    oneLine: "주식 1주당 벌어들인 이익입니다.",
    simple: "내가 가진 주식 1주에 얼마만큼의 이익이 붙는지 보는 자료예요.",
  ...
  },
  {
    ...
    caution: "부채를 많이 써서 ROE가 높아지는 경우도 있어 부채비율과 함께 봐야 합니다.",
    related: ["PBR", "부채비율"]
  },
  {
    term: "영업이익",
  ...
  },
  {
    ...
    caution: "주가만 보고 비싸다 판단하지 말고 시가총액과 이익 규모를 같이 봐야 합니다.",
    related: ["주가", "PER"]
  },
  {
    term: "ETF",
